...
def main(args):
    ...
    if args.use_original_dataset:
        X_data, is_original_dataset, original_indices, target_values, feature_columns, X_original_values = load_train_data(args.client, args.dataset)
        dataset_desc = "Dataset original completo"
    else:
        X_data, is_original_dataset, original_indices, target_values, feature_columns, X_original_values = X_train, False, None, None, None, None
    ...
    original_instance = X_original_values[instance_idx] if X_original_values is not None else np.copy(instance)
